...
1. **Verify outer-beam addressing at the venue** (Beam1=SL / Beam4=SR working conclusion above): wiggle pan on DMX 280, watch which truss end moves. Then update the busking doc's fixture map + SL/SR scene labels to match.
