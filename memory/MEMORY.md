...
- [project_fhc_previz.md](project_fhc_previz.md) — **Home for FHC previsualization** — Blender build (FHC_Stage.blend) + QLC+→Art-Net→BlenderDMX link, PROVEN end-to-end 2026-06-09 (4 M1 Beams rigged, QLC+ faders drive the viewport live). Debugging lessons + render limits inside.
