...
- [project_chronical.md](project_chronical.md) — ChroniCal: macOS SwiftUI app wrapping Python calendar pipeline for Chronicle Books. Private repo at `github.com/DorcusTitanus/happenstance`. v0.5 shipped 2026-05-16: docx → body XML pipeline for Wall and Daily, Holiday validator (xlsx wins), lint pass.
